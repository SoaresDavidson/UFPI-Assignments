...
public class Produto {
	...
	public void comprar(int quant, double val, Date validade) throws DadosInvalidos,ProdutoNaoPerecivel {
		...
		if (dataNaoNula(validade)) {
			if (this instanceof ProdutoPerecivel) {
				...
				throw new ProdutoNaoPerecivel(this);
			}
		}
